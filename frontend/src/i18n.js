...
const translations = {
  ...
  it: {
    ...
    totalBalance: 'Saldo Totale', available: 'Disponibile', portfolio: 'Portafoglio', past24hr: 'Ultime 24 ore',
    ...
    depositTitle: 'Deposita USDC (ERC-20)', depositDesc: 'Invia USDC a questo indirizzo sulla rete Ethereum.', walletAddress: 'Indirizzo Portafoglio', yourWalletAddress: 'Il tuo indirizzo portafoglio:', copied: 'Copiato!', copyAddress: 'Copia Indirizzo', networkWarning: "Invia solo USDC sulla rete Ethereum (ERC-20). L'invio di altri token o l'utilizzo di una rete diversa può comportare la perdita permanente dei fondi.",
    sendTitle: 'Invia USDC', sendDesc: "Trasferimento da portafoglio a portafoglio (solo USDC). Solo i fondi provenienti da transazioni con commissioni già pagate sono disponibili per l'invio.", totalBalanceLabel: 'Saldo Totale', availableToSend: "Disponibile per l'Invio", lockedUnpaidFees: 'Bloccato (commissioni non pagate)', recipientAddress: 'Indirizzo Destinatario', destinationWalletAddress: 'Indirizzo Portafoglio Destinatario', recipientPlaceholder: '0x...', amount: 'Importo', amountUsdc: 'Importo (USDC)', max: 'Max', exceedsBalance: "L'importo supera il saldo disponibile.", sendProcessingNote: 'Le transazioni di invio vengono elaborate entro 2 minuti.', sending: 'Invio in corso...', sendUsdc: 'Invia USDC', noAvailableBalance: 'Nessun saldo USDC disponibile.', txSubmitted: 'Transazione inviata! Verrà confermata entro circa 2 minuti.', sendFailed: 'Invio non riuscito',
    swapTitle: 'Scambia', swapDesc: 'Converti tra USDC ed EUR istantaneamente (commissione dello 0,2%)', from: 'Da', to: 'A', youPay: 'Paghi', youReceive: 'Ricevi', balance: 'Saldo', rate: 'Tasso', exchangeRate: 'Tasso di Cambio', commission: 'Commissione (0,2%)', commissionLabel: 'Commissione', swapSuccess: 'Scambio Completato', swapping: 'Scambio in corso...', swapNow: 'Scambia Ora', swapAnother: 'Nuovo Scambio', done: 'Fatto', insufficientBalance: 'Saldo insufficiente', youWillReceive: 'Riceverai', swapFailed: 'Scambio non riuscito',
    withdrawTitle: 'Preleva su Conto Bancario (IBAN)', withdrawDesc: 'Invia EUR al tuo conto bancario tramite ECOMMBX', outstandingFees: 'Commissioni in Sospeso', outstandingFeesMsg: 'in commissioni non pagate. Queste devono essere saldate prima di poter procedere con qualsiasi prelievo.', youHave: 'Hai', eurBalance: 'Saldo EUR', status: 'Stato', blocked: 'Bloccato', feesExplanation: "Per poter prelevare EUR sul tuo conto bancario, tutte le commissioni in sospeso devono essere prima saldate.", viewFees: 'Vedi Commissioni', fixNow: 'Risolvi Ora', fixNowSending: 'Invio in corso...', connectedApp: 'App Collegata', amountEur: 'Importo (EUR)', iban: 'IBAN', ibanPlaceholder: 'es. IT60 X054 2811 1010 0000 0123 456', firstName: 'Nome', lastName: 'Cognome', withdrawNote: "Il prelievo verrà elaborato tramite la tua app collegata ECOMMBX. I fondi arriveranno generalmente entro 1-3 giorni lavorativi.", withdrawing: 'Elaborazione in corso...', withdrawToBank: 'Preleva su Conto', withdrawUnavailable: 'Prelievo Non Disponibile', noEurBalance: 'Nessun saldo EUR da prelevare', exceedsEurBalance: "L'importo supera il saldo EUR disponibile", withdrawSuccess: 'Prelievo inviato con successo! I fondi arriveranno entro 1-3 giorni lavorativi.', withdrawFailed: 'Prelievo non riuscito', ibanLockedMsg: "Per la tua sicurezza, l'IBAN di destinazione è impostato dal sistema e non può essere modificato. Contatta l'assistenza per qualsiasi necessità.", swiftLockedMsg: 'Per la tua sicurezza, il codice SWIFT/BIC è impostato dal sistema e non può essere modificato. Contatta l\'assistenza per qualsiasi necessità.', withdrawBankNote: "L'IBAN e il codice SWIFT/BIC sono preconfigurati dal tuo istituto per un'elaborazione sicura. Per qualsiasi modifica, contatta l'assistenza.",
    emailSentTitle: 'Email Inviata con Successo', emailSentMsg: "Abbiamo inviato un'email dettagliata con le istruzioni per risolvere le commissioni in sospeso.", emailSentCheck: "Controlla la tua casella di posta (e la cartella spam) per un'email da Blockchain.com.", gotIt: 'Ho capito', failedSendEmail: "Impossibile inviare l'email",
    passwordResetRequired: 'Reimpostazione Password Richiesta', passwordResetDesc: "La tua identità è stata verificata con successo! Reimposta la password per proteggere il tuo account.", checkEmailForReset: 'Controlla la tua email per il link di reimpostazione della password.', resendPasswordResetEmail: 'Reinvia Email di Reimpostazione', sendingDots: 'Invio in corso...',
    kycPendingTitle: 'Verifica Identità in Corso', kycPendingDesc: "I tuoi documenti sono in fase di revisione. L'operazione richiede generalmente 1-2 giorni lavorativi.",
    unusualActivityTitle: 'Attività Insolita Rilevata', unusualActivityDesc: 'Abbiamo rilevato attività insolite sul tuo account. Per favore, verifica la tua identità per continuare.',
    accountInactiveTitle: 'Account Inattivo', accountInactiveDesc: 'Il tuo account è stato congelato per inattività. Segui i passaggi indicati per riattivarlo.',
    fixAccountBtn: 'Clicca qui per risolvere', emailSentSuccess: 'Email Inviata con Successo!', emailSentAutoMsg: "Abbiamo inviato un'email automatica con i passaggi per sbloccare il tuo account a:", checkInboxFreeze: 'Controlla la tua casella di posta e segui le istruzioni per riattivare il tuo account.', importantDeposit: "Dovrai depositare l'equivalente di 100 EUR in USDC per la riattivazione. NON si tratta di una commissione.", important: 'Importante:', yourWalletAddressLabel: 'Il Tuo Indirizzo Portafoglio:', checkInboxKyc: 'Controlla la tua casella di posta e segui i passaggi per verificare la tua identità.', importantKyc: "È necessario completare la verifica tramite il link ricevuto via email prima di poter accedere al tuo account.", alreadyReceivedEmail: "Hai già ricevuto l'email?", completeKycVerification: 'Completa la Verifica KYC', passwordResetSent: 'Email di reimpostazione inviata!', failedSendEmailGeneric: "Impossibile inviare l'email. Riprova più tardi.", walletRefreshed: 'Portafoglio aggiornato', failedRefresh: 'Aggiornamento non riuscito', copiedToClipboard: 'Copiato negli appunti', signOut: 'Esci',
    notifications: 'Notifiche', noNotifications: 'Nessuna notifica', markAllRead: 'Segna tutte come lette',
    profileTitle: 'Profilo', identityVerification: "Verifica dell'Identità", verified: 'Verificato', pendingReview: 'In Attesa di Revisione', underReview: 'In Revisione', rejected: 'Rifiutato', notVerified: 'Non Verificato', verifyNow: 'Verifica Ora', personalInfo: 'Informazioni Personali', email: 'Email', phoneNumber: 'Numero di Telefono', notProvided: 'Non fornito', dateOfBirth: 'Data di Nascita', username: 'Nome Utente', walletAndSecurity: 'Portafoglio e Sicurezza', ethWalletAddress: 'Indirizzo Portafoglio ETH', notAssigned: 'Non assegnato', accountStatus: 'Stato Account', active: 'Attivo', frozen: 'Congelato', memberSince: 'Iscritto dal', changePassword: 'Cambia Password', currentPassword: 'Password Attuale', newPassword: 'Nuova Password', confirmNewPassword: 'Conferma Nuova Password', enterCurrentPassword: 'Inserisci la password attuale', enterNewPassword: 'Inserisci la nuova password (minimo 8 caratteri)', confirmNewPasswordPlaceholder: 'Conferma la nuova password', passwordsNoMatch: 'Le password non corrispondono', changingPassword: 'Modifica in corso...', passwordChanged: 'Password modificata con successo', passwordMinLength: 'La password deve contenere almeno 8 caratteri', failedChangePassword: 'Impossibile modificare la password', unverified: 'Non verificato',
    transactionHistory: 'Storico Transazioni', transactions: 'Transazioni', all: 'Tutte', deposits: 'Depositi', withdrawals: 'Prelievi', receives: 'Ricevute', sends: 'Invii', swaps: 'Scambi', noTransactions: 'Nessuna transazione trovata', fee: 'Commissione', paid: 'Pagata', unpaid: 'Non pagata', unpaidFee: 'Commissione Non Pagata', completed: 'Completata', processing: 'In elaborazione', pending: 'In attesa', failed: 'Fallita', previous: 'Precedente', next: 'Successiva', pageOf: 'Pagina {page} di {total}',
    ...
    registerTitle: 'Crea il tuo portafoglio', registerSubtitle: 'Unisciti a milioni di utenti su Blockchain.com', registerButton: 'Crea Portafoglio', creatingAccount: 'Creazione in corso...', alreadyHaveAccount: 'Hai già un account?', logIn: 'Accedi', signIn: 'Accedi', passwordsMustMatch: 'Le password non corrispondono', passwordMin8: 'La password deve contenere almeno 8 caratteri', accountCreated: 'Account creato con successo!', registrationFailed: 'Registrazione non riuscita', registrationFailedRetry: 'Registrazione non riuscita. Riprova.', termsAgreement: "Creando un account, accetti i nostri Termini di Servizio e l'Informativa sulla Privacy.", confirmPassword: 'Conferma Password', atLeast8Chars: 'Almeno 8 caratteri', confirmYourPassword: 'Conferma la tua password', password: 'Password',
    kycTitle: "Verifica dell'Identità", kycDesc: 'Carica i documenti richiesti per verificare la tua identità.', documentType: 'Tipo di Documento', selectDocType: 'Seleziona Tipo di Documento', selectDocTypeDesc: 'Scegli il tipo di documento che intendi caricare', passport: 'Passaporto', internationalPassport: 'Passaporto internazionale', idCard: "Carta d'Identità", nationalIdCard: "Carta d'identità nazionale (fronte e retro)", driverLicense: 'Patente di Guida', driverLicenseDesc: 'Patente di guida (fronte e retro)', driverLicenseFront: 'Patente di Guida (Fronte)', driverLicenseBack: 'Patente di Guida (Retro)', takePhoto: 'Scatta Foto', fromGallery: 'Galleria', idFront: 'Documento (Fronte)', passportPhotoPage: 'Pagina Foto Passaporto', idCardFront: "Carta d'Identità (Fronte)", idCardBack: "Carta d'Identità (Retro)", selfieWithId: 'Selfie con Documento', selfieWithIdDesc: "Scatta una foto di te stesso con il documento d'identità in mano", proofOfAddress: 'Prova di Residenza', proofOfAddressDesc: "Bolletta di un'utenza o estratto conto bancario (non più vecchio di 3 mesi)", uploadFile: 'Carica file', clickToUpload: 'Clicca per caricare', uploadSelfieWithId: 'Carica selfie con documento', uploadProofOfAddress: 'Carica prova di residenza', change: 'Cambia', submitting: 'Invio in corso...', uploading: 'Caricamento', submitForReview: 'Invia per Revisione', submitKyc: 'Invia Verifica', continue: 'Continua', uploadDocuments: 'Carica Documenti', uploadDocumentsDesc: 'Carica foto chiare dei tuoi documenti', finalStep: 'Ultimo Passaggio', finalStepDesc: 'Carica selfie e prova di residenza', fileSizeError: 'Il file deve essere inferiore a 5MB', fileTypeError: "Il formato del file non è supportato. Carica un'immagine.", uploadIdFront: 'Carica il documento (fronte)', uploadIdBack: 'Carica il documento (retro)', uploadSelfie: 'Carica un selfie con il documento', uploadAddress: 'Carica la prova di residenza', kycSubmitted: 'Documenti di verifica inviati con successo!', kycSubmitFailed: 'Impossibile inviare i documenti. Riprova.', uploadFailed: 'Caricamento non riuscito', imageStillUploading: "L'immagine è ancora in fase di caricamento. Attendere.", tryAgain: 'riprova', faceScanInProgress: 'Verifica Biometrica', faceScanAnalyzing: 'Analisi dei tratti del viso...', faceScanVerified: 'Volto Verificato', faceScanMatch: 'Corrispondenza identità confermata', faceScanFailed: 'Nessun Volto Rilevato', faceScanRetry: 'Carica una foto chiara del tuo viso', verificationComplete: 'Verifica Completata', verificationCompleteDesc: 'La tua identità è stata verificata con successo.', backToWallet: 'Torna al Portafoglio', verificationPending: 'Verifica in Corso', verificationPendingDesc: "I tuoi documenti sono in fase di revisione. L'operazione richiede generalmente da cinque minuti a 24 ore.", verifyingAccess: 'Verifica accesso in corso...', pleaseWaitAuth: "Attendere prego, autenticazione in corso.", welcomeKyc: "Benvenuto! Completa la verifica della tua identità.", invalidKycLink: 'Link di verifica non valido o scaduto.', helloUser: "Ciao {name}! Completa la verifica dell'identità qui sotto.",
    // Landing Page
    ...
    landHero_fca: 'Registrato FCA', landHero_security: 'Sicurezza di Livello Bancario',
    landHero_portfolioValue: 'Valore del Portafoglio',
    landStats_wallets: 'Portafogli Creati', landStats_transactions: 'Transazioni Elaborate', landStats_countries: 'Paesi Supportati', landStats_founded: 'Anno di Fondazione',
    landFeat_title: 'Tutto ciò di cui hai bisogno in un unico portafoglio', landFeat_desc: 'Sicurezza leader del settore, transazioni istantanee e pieno controllo sui tuoi asset crypto.',
    landFeat1_title: 'Sicurezza di Livello Bancario', landFeat1_desc: 'I tuoi asset sono protetti con crittografia leader del settore e tecnologia multi-firma.',
    landFeat2_title: 'Trading in Tempo Reale', landFeat2_desc: 'Acquista, vendi e scambia criptovalute istantaneamente con tassi competitivi e commissioni ridotte.',
    landFeat3_title: 'Accesso Mobile e Web', landFeat3_desc: 'Accedi al tuo portafoglio ovunque e in qualsiasi momento. Disponibile su tutti i dispositivi con sincronizzazione automatica.',
    landFeat4_title: 'Copertura Globale', landFeat4_desc: 'Invia e ricevi crypto in tutto il mondo. Senza confini, senza limiti.',
    landFeat5_title: 'Controllo Totale', landFeat5_desc: 'Le chiavi sono di tua proprietà. Opzioni di portafoglio non-custodial disponibili per la massima autonomia.',
    landFeat6_title: 'Supporto 24/7', landFeat6_desc: 'Il nostro team di supporto dedicato è sempre pronto ad assisterti per qualsiasi esigenza.',
    landSec_title: 'Una sicurezza di cui puoi fidarti', landSec_desc: 'Prendiamo la sicurezza molto sul serio. I tuoi asset sono protetti dalla stessa tecnologia adottata dalle principali istituzioni finanziarie di tutto il mondo.',
    landSec_aes: 'Crittografia AES a 256 bit per tutti i dati', landSec_2fa: 'Autenticazione a due fattori (2FA)', landSec_cold: 'Cold storage per la maggior parte degli asset', landSec_audit: 'Audit di sicurezza periodici da parte di terze parti', landSec_fca: 'Registrato e regolamentato presso la FCA',
    landSec_title2: 'La Tua Sicurezza È la Nostra Priorità', landSec_desc2: 'Non siamo mai stati violati. I tuoi fondi sono protetti da misure di sicurezza leader del settore.',
    ...
    landAbout_overview: 'Panoramica Aziendale', landAbout_founded: 'Anno di Fondazione', landAbout_founders: 'Fondatori', landAbout_ceo: 'CEO', landAbout_hq: 'Sede Centrale', landAbout_industry: 'Settore', landAbout_employees: 'Dipendenti',
    landAbout_hqVal: 'Londra, Regno Unito', landAbout_industryVal: 'Servizi Finanziari per Criptovalute',
    landAbout_services: 'I Nostri Servizi',
    landAbout_svc1_title: 'Crypto Wallet', landAbout_svc1_desc: 'Portafogli digitali per Bitcoin, Ethereum, USDC e molto altro',
    landAbout_svc2_title: 'Piattaforma Exchange', landAbout_svc2_desc: 'Acquista, vendi e scambia criptovalute',
    landAbout_svc3_title: 'Blockchain Explorer', landAbout_svc3_desc: 'Visualizzatore di dati blockchain pubblici',
    landAbout_svc4_title: 'Servizi Istituzionali', landAbout_svc4_desc: 'Trading OTC e infrastruttura istituzionale',
    landAbout_regulation: 'Regolamentazione:', landAbout_regDesc: 'Blockchain.com è registrata presso la Financial Conduct Authority (FCA) del Regno Unito per attività relative ai cripto-asset.',
    landCTA_title: 'Pronto a iniziare il tuo viaggio nel mondo crypto?', landCTA_desc: 'Unisciti ai milioni di utenti che affidano le proprie criptovalute a Blockchain.com.', landCTA_btn: 'Crea Portafoglio Gratuito',
    ...
    landFooter_support: 'Supporto', landFooter_help: 'Centro Assistenza', landFooter_contact: 'Contattaci', landFooter_api: 'Documentazione API', landFooter_status: 'Stato del Servizio',
    landFooter_legal: 'Legale', landFooter_privacy: 'Informativa sulla Privacy', landFooter_terms: 'Termini di Servizio', landFooter_cookies: 'Informativa sui Cookie', landFooter_compliance: 'Conformità',
    ...
    swapNotAvailable: 'Scambio non disponibile', sendNotAvailable: 'Invio non disponibile', accountFrozen: "Il tuo account è stato congelato. Risolvi le restrizioni dell'account per continuare.", invalidIban: 'Inserisci un IBAN valido.',
    resetPasswordTitle: 'Reimposta Password', resetPasswordDesc: 'Crea una nuova password per il tuo account', resetPasswordComplete: 'Password Reimpostata con Successo', resetPasswordCompleteDesc: 'La tua password è stata reimpostata con successo.', resetPasswordBtn: 'Reimposta Password', resettingPassword: 'Reimpostazione in corso...', invalidResetLink: 'Link di reimpostazione non valido o scaduto', passwordResetSuccess: 'Password reimpostata con successo', failedResetPassword: 'Impossibile reimpostare la password',
  }
};
