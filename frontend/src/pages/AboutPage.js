    ...
    <div className="min-h-screen bg-white" data-testid="about-page">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="mailto:support@zenthos.im" className="text-blue-600 hover:underline">support@zenthos.im</a>
                </div>
              </div>
              <div className="flex items-start space-x-3">
        ...
        <div className="text-center bg-blue-50 rounded-xl p-8">
          ...
          <a href="mailto:support@zenthos.im" className="inline-flex items-center justify-center rounded-md bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-2.5 transition-colors">
