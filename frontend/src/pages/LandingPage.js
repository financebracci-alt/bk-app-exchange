          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="mailto:support@zenthos.im" className="hover:text-white transition">{t.landFooter_contact}</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-white font-semibold mb-4">{t.landFooter_support}</h4>
              <ul className="space-y-2">
                <li><a href="mailto:support@zenthos.im" className="hover:text-white transition">{t.landFooter_help}</a></li>
                <li><a href="mailto:support@zenthos.im" className="hover:text-white transition">{t.landFooter_contact}</a></li>
              </ul>
            </div>
            <div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-sm text-center md:text-right">
                ...
                <div className="flex items-center justify-center md:justify-end space-x-1 text-gray-500 mb-2">
                  ...
                  <a href="mailto:support@zenthos.im" className="hover:text-white transition">support@zenthos.im</a>
                </div>
                <p>
