      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
        <div className="prose prose-gray max-w-none">
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            ...
            <p className="text-gray-600">Email: <a href="mailto:support@zenthos.im" className="text-blue-600 hover:underline">support@zenthos.im</a></p>
          </div>
        </div>
      </main>
